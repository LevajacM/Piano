...
button1.addEventListener("click", () => {
  ...
  bookBtn.classList.add("book-none");
  sec.classList.add("background-dark");
  glitch.classList.add("glitch-dark");
  ...
  new Promise((resolve) => {
    ...
    sec.classList.remove("background-dark");
    canvas.classList.remove("show-canvas");
    setTimeout(() => {
      bookBtn.classList.remove("book-none");
      glitch.classList.remove("glitch-dark");
    }, 2000);
  });
});
...
function vinylBtn1Function(e) {
  ...
  if (
    e.currentTarget.parentElement.nextElementSibling.firstElementChild.firstElementChild.classList.contains(
      "select-icon"
    )
  ) {
    e.currentTarget.parentElement.nextElementSibling.firstElementChild.firstElementChild.classList.remove(
      "select-icon"
    );
  }
  if (
    e.currentTarget.parentElement.nextElementSibling.nextElementSibling.firstElementChild.firstElementChild.classList.contains(
      "select-icon"
    )
  ) {
    e.currentTarget.parentElement.nextElementSibling.nextElementSibling.firstElementChild.firstElementChild.classList.remove(
      "select-icon"
    );
  }
  ...
  if (
    e.currentTarget.parentElement.nextElementSibling.classList.contains(
      "tune-link"
    )
  ) {
  ...
  if (
    e.currentTarget.parentElement.nextElementSibling.nextElementSibling.classList.contains(
      "tune-link"
    )
  ) {
...
function vinylBtn2Function(e) {
  ...
  if (
    e.currentTarget.parentElement.previousElementSibling.firstElementChild.firstElementChild.classList.contains(
      "select-icon"
    )
  ) {
    e.currentTarget.parentElement.previousElementSibling.firstElementChild.firstElementChild.classList.remove(
      "select-icon"
    );
  }
  if (
  ...
  if (
    e.currentTarget.parentElement.previousElementSibling.classList.contains(
      "tune-link"
    )
  ) {
...
function vinylBtn3Function(e) {
  ...
  if (
    e.currentTarget.parentElement.previousElementSibling.previousElementSibling.firstElementChild.firstElementChild.classList.contains(
      "select-icon"
    )
  ) {
    e.currentTarget.parentElement.previousElementSibling.previousElementSibling.firstElementChild.firstElementChild.classList.remove(
      "select-icon"
    );
  }
  if (
  ...
  if (
    e.currentTarget.parentElement.previousElementSibling.previousElementSibling.classList.contains(
      "tune-link"
    )
  ) {
...
section.addEventListener("mouseover", (e) => {
  if (
    ...
    e.target.classList.contains("con1") ||
